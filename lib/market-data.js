...
export const dataStatuses = {
  ...
  awaiting_future_window: {
    ...
    tone: "amber",
    description: "30G gibi ileri pencere tarihi henüz gelmediği için hesap tamamlanmadı."
  },
  calculated: {
    label: "Hesaplandı",
    tone: "green",
...
export const companies = [
  ...
  },
  {
    ...
    sector: "Madencilik",
    priority: 20,
    description: "Altın fiyatları, operasyon ve hukuki gelişmelerle izlenir.",
    watchReason: "Emtia fiyatı ve şirket haberleri birlikte izlenebildiği için ilk evrene uygundur.",
    eventTargets: ["Bilanço", "Emtia etkisi", "Hukuki gelişme"]
  }
];
