...
| 20 | KOZAL | Finansal sonuç, altın fiyatı veya sektör etkisi, hukuki süreç |
...
Bu kuyruğun ardından yapılacak ilk iş, ilk 10 hedef için gerçek kaynak linklerini bulup `candidate` kayıtlar oluşturmaktır. Böylece örnek veriden gerçek editör akışına geçilir.
